...
class MainMenuWindow(ttk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        master.title("Total Garage And Service Station")
        ...
        title_label = ttk.Label(title_frame, text="MAIN MENU",
                                 font="Arial 60 bold", foreground='#FF0000')
        title_label.pack()
        # Date and Time Label
        ...
        # Program Title
        program_title_label = ttk.Label(body_frame, text="Total Garage And Service Station",
                                     font="Arial 45 bold", foreground='#FF0000')
