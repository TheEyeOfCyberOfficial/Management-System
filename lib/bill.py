...
if __name__ == "__main__":
    ...
    items = [['Set Wet Hair Gel Cool, 50ml', 10, 'PKR 50.5', 'PKR 505.0'], ['Set Wet Hair Gel Cool, 50ml', 20, 'PKR 50.5', 'PKR 1010.0'], ['Fair & Lovely Women, 50g', 50, 'PKR 97.0', 'PKR 4850.0'], ['Nivea Lip Balm, 4.8g', 140, 'PKR 105.0', 
        'PKR 14700.0'], ['testing', 1, 'PKR 1.0', 'PKR 10.0'], ['testing', 1, 'PKR 10.0', 'PKR 10.0']]
